    ...
    <div class="card-body">
        ...
        <div class="text-center">
            ...
            if (!empty($_POST['tanggal_awal'])) {
               ?>
               <a href="cetak-kas-masuk.php?tanggal_awal=<?php echo $tanggal_awal ?>&tanggal_akhir=<?php echo $tanggal_akhir ?>" class="btn btn-success btn-sm mb-3" target="_blank">print</a>
               <?php
            }else{
