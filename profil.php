	...
	if (isset($_FILES['foto'])) {
		...
		if (move_uploaded_file($foto_tmp, $path)) {
			...
			if ($query) {
				...
				echo '<script>alert("profil berasil di update");location.href="?page=profil";</script>';
			}
		}
	}
...
if (isset($_POST['password_lama'])) {
	...
	if ($data == 0) {
		...
		if ($query) {
			echo '<script>alert("Password berasil diupdate");location.href="?page=profil";</script>';
		}
	}
}
	...
	<div class="col-md-4 col-xl-3">
		<div class="card mb-3">
			...
			<div class="card-body text-center">
				<img src="foto/<?php echo $_SESSION['user']['foto'] ?>" alt="<?php echo $_SESSION['user']['nama'] ?>" class="img-fluid rounded-circle mb-2" width="128" height="128" />
